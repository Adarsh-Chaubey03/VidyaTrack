...
function Navbar() {
  ...
  return (
    <>
      ...
      <div className="w-full flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 py-2 border-b bg-gradient-to-r from-emerald-600 via-emerald-500 to-rose-500">
